...
public class Medium extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7885517981716222129L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Medium\",\"namespace\":\"rheeluke.streams.avro\",\"fields\":[{\"name\":\"display_url\",\"type\":\"string\"},{\"name\":\"expanded_url\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"url\",\"type\":\"string\"}],\"connect.name\":\"rheeluke.streams.avro.Medium\"}");
   ...
   * @return A new Medium RecordBuilder
   */
  public static rheeluke.streams.avro.Medium.Builder newBuilder() {
    return new rheeluke.streams.avro.Medium.Builder();
  }
   ...
   * @return A new Medium RecordBuilder
   */
  public static rheeluke.streams.avro.Medium.Builder newBuilder(rheeluke.streams.avro.Medium.Builder other) {
    return new rheeluke.streams.avro.Medium.Builder(other);
  }
   ...
   * @return A new Medium RecordBuilder
   */
  public static rheeluke.streams.avro.Medium.Builder newBuilder(rheeluke.streams.avro.Medium other) {
    return new rheeluke.streams.avro.Medium.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Medium>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(rheeluke.streams.avro.Medium.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(rheeluke.streams.avro.Medium other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.display_url)) {
        this.display_url = data().deepCopy(fields()[0].schema(), other.display_url);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder setDisplayUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder clearDisplayUrl() {
      display_url = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder setExpandedUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder clearExpandedUrl() {
      expanded_url = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder setUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public rheeluke.streams.avro.Medium.Builder clearUrl() {
      url = null;
